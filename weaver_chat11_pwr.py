# === KNOWLEDGE WEAVER – EMERGENT DREAM-HYBRID TRADER EDITION (Fully Fixed) ===
# Integration of Dream Core self-learning neural network
# Fixed: consciousness initialization order & safe dream_network access
# All original architecture, dreams, evolution, UI preserved
...
# Enhanced NeuralLayer with clustering
class NeuralLayer:
    def __init__(self):
        self.memory = deque(maxlen=200)
        self.associations = []
...
class ConsciousnessLayer:
    def __init__(self):
        ...
        self.dream_network = HybridNeuralNetwork()  # Dream Core neural engine
...
# === Initialize Consciousness First (Fixed Order) ===
...
# === Feed Market Data into Dream Network (Safe Access) ===
...
if not st.session_state.messages:
    ...
    greeting += "Ask me about price, patterns, or let me weave insights from the flow."
...
if prompt := st.chat_input("Your message..."):
    ...
    if any(x in lower for x in ["trading insight", "analyze trades", "trading pattern", "current market", "latest price"]):
...
st.caption("Local • Trading-Aware • Dream-Hybrid Neural Engine • Auto-Refresh Every 30 Min • Powered by Ollama")